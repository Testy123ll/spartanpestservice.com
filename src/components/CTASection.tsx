        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div>
            ...
            <p className="text-primary-foreground/60 text-lg mb-10 max-w-md">
              Get your free inspection today. We'll create a custom treatment plan just for your property.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-primary-foreground font-semibold mb-1">Call Us Anytime</h4>
                  <a href="tel:5125551234" className="text-gold text-lg font-semibold hover:underline">
                    (512) 555-1234
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-primary-foreground font-semibold mb-1">Service Area</h4>
                  <p className="text-primary-foreground/55">
                    Austin, Round Rock, Cedar Park, Pflugerville, and surrounding areas
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-primary-foreground font-semibold mb-1">Hours</h4>
                  <p className="text-primary-foreground/55">
